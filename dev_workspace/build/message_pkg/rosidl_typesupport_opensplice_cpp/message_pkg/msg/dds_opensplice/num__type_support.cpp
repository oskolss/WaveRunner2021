...
#include "message_pkg/msg/num__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_Num = message_pkg::msg::dds_::Num_;
using __ros_msg_type_Num = message_pkg::msg::Num;

static message_pkg::msg::dds_::Num_TypeSupport __type_support_Num;
...
{
  return &message_pkg::msg::typesupport_opensplice_cpp::Num_handle;
}
