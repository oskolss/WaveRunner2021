...
#include "message_pkg/msg/mecanum_input__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_MecanumInput = message_pkg::msg::dds_::MecanumInput_;
using __ros_msg_type_MecanumInput = message_pkg::msg::MecanumInput;

static message_pkg::msg::dds_::MecanumInput_TypeSupport __type_support_MecanumInput;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_message_pkg
const char *
register_type__MecanumInput(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_MecanumInput.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_MecanumInput & ros_message,
  __dds_msg_type_MecanumInput & dds_message)
{
  // member.name inputvalue
  {
    size_t size = 3;
    for (DDS::ULong i = 0; i < size; i++) {
      dds_message.inputvalue_[i] = ros_message.inputvalue[i];
    }
  }
}
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_message_pkg
const char *
publish__MecanumInput(
  void * untyped_topic_writer,
  const void * untyped_ros_message)
{
  DDS::DataWriter * topic_writer = static_cast<DDS::DataWriter *>(untyped_topic_writer);

  const __ros_msg_type_MecanumInput & ros_message = *static_cast<const __ros_msg_type_MecanumInput *>(untyped_ros_message);
  __dds_msg_type_MecanumInput dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_MecanumInput & dds_message,
  __ros_msg_type_MecanumInput & ros_message)
{
  // member.name inputvalue
  {
    size_t size = 3;
    for (DDS::ULong i = 0; i < size; i++) {
      ros_message.inputvalue[i] = dds_message.inputvalue_[i];
    }
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_MecanumInput & ros_message = *static_cast<__ros_msg_type_MecanumInput *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_MecanumInput);
...
static message_type_support_callbacks_t MecanumInput_callbacks = {
  "message_pkg::msg",
  "MecanumInput",
  &register_type__MecanumInput,
  &publish__MecanumInput,
...
static rosidl_message_type_support_t MecanumInput_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &MecanumInput_callbacks,
...
{
  return &message_pkg::msg::typesupport_opensplice_cpp::MecanumInput_handle;
}
