...
#include "message_pkg/srv/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddThreeInts_Request__ros_msg_type = message_pkg__srv__AddThreeInts_Request;
...
size_t get_serialized_size_message_pkg__srv__AddThreeInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddThreeInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_pkg__srv__AddThreeInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_pkg
size_t max_serialized_size_message_pkg__srv__AddThreeInts_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_pkg__srv__AddThreeInts_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_pkg, srv, AddThreeInts_Request)() {
...
using _AddThreeInts_Response__ros_msg_type = message_pkg__srv__AddThreeInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_pkg
size_t get_serialized_size_message_pkg__srv__AddThreeInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeInts_Response__ros_msg_type * ros_message = static_cast<const _AddThreeInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_message_pkg__srv__AddThreeInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_pkg
size_t max_serialized_size_message_pkg__srv__AddThreeInts_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_pkg__srv__AddThreeInts_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_pkg, srv, AddThreeInts_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_pkg, srv, AddThreeInts)() {
