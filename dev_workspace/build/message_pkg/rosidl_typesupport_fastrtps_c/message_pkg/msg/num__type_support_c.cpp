...
#include "message_pkg/msg/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = message_pkg__msg__Num;
...
size_t get_serialized_size_message_pkg__msg__Num(
  const void * untyped_ros_message,
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_pkg__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_pkg
size_t max_serialized_size_message_pkg__msg__Num(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_pkg__msg__Num(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_pkg, msg, Num)() {
