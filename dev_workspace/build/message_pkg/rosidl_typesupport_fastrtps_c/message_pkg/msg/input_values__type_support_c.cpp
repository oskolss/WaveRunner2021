...
#include "message_pkg/msg/input_values__rosidl_typesupport_fastrtps_c.h"
...
using _InputValues__ros_msg_type = message_pkg__msg__InputValues;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 6;
    auto array_ptr = ros_message->inputvalues;
...
size_t get_serialized_size_message_pkg__msg__InputValues(
  const void * untyped_ros_message,
...
static uint32_t _InputValues__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_pkg__msg__InputValues(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_pkg
size_t max_serialized_size_message_pkg__msg__InputValues(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_pkg__msg__InputValues(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_pkg, msg, InputValues)() {
