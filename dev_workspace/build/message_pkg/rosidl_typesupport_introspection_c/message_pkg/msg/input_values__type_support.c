...
#include <stddef.h>
#include "message_pkg/msg/input_values__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember InputValues__rosidl_typesupport_introspection_c__InputValues_message_member_array[1] = {
  {
    "inputvalues",  // name
    ...
    offsetof(message_pkg__msg__InputValues, inputvalues),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers InputValues__rosidl_typesupport_introspection_c__InputValues_message_members = {
  ...
  1,  // number of fields
  sizeof(message_pkg__msg__InputValues),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_pkg, msg, InputValues)() {
