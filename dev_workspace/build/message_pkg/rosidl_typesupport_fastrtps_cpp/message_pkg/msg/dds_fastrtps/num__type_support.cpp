...
#include "message_pkg/msg/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const message_pkg::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_pkg::msg::Num *>(
    untyped_ros_message);
...
{
  return &message_pkg::msg::typesupport_fastrtps_cpp::_Num__handle;
}
