...
#include "message_pkg/msg/input_values__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.inputvalues[0]);
...
{
  auto typed_message =
    static_cast<const message_pkg::msg::InputValues *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_pkg::msg::InputValues *>(
    untyped_ros_message);
...
{
  return &message_pkg::msg::typesupport_fastrtps_cpp::_InputValues__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_pkg, msg, InputValues)() {
  return &message_pkg::msg::typesupport_fastrtps_cpp::_InputValues__handle;
}
