...
#include "message_pkg/srv/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const message_pkg::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_pkg::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &message_pkg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const message_pkg::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<message_pkg::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &message_pkg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &message_pkg::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
