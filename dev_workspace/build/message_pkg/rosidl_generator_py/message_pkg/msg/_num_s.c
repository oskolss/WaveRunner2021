...
bool message_pkg__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "message_pkg.msg._num.Num",
        full_classname_dest, 24) == 0);
  }
  message_pkg__msg__Num * ros_message = _ros_message;
  {  // num
...
PyObject * message_pkg__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_pkg.msg._num");
