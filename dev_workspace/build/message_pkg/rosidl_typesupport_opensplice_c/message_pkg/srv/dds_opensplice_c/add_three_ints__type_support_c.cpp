...
using __dds_msg_type_message_pkg__srv__AddThreeInts_Request = message_pkg::srv::dds_::AddThreeInts_Request_;
using __ros_msg_type_message_pkg__srv__AddThreeInts_Request = message_pkg__srv__AddThreeInts_Request;

static message_pkg::srv::dds_::AddThreeInts_Request_TypeSupport _type_support_message_pkg__srv__AddThreeInts_Request;

static const char *
register_type_message_pkg__srv__AddThreeInts_Request(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_message_pkg__srv__AddThreeInts_Request.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_message_pkg__srv__AddThreeInts_Request(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const __ros_msg_type_message_pkg__srv__AddThreeInts_Request * ros_message = static_cast<const __ros_msg_type_message_pkg__srv__AddThreeInts_Request *>(untyped_ros_message);
  __dds_msg_type_message_pkg__srv__AddThreeInts_Request * dds_message = static_cast<__dds_msg_type_message_pkg__srv__AddThreeInts_Request *>(untyped_dds_message);
  // Field name: a
  {
...
static const char *
publish_message_pkg__srv__AddThreeInts_Request(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_message_pkg__srv__AddThreeInts_Request dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__srv__AddThreeInts_Request(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_message_pkg__srv__AddThreeInts_Request(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_message_pkg__srv__AddThreeInts_Request * dds_message = static_cast<const __dds_msg_type_message_pkg__srv__AddThreeInts_Request *>(untyped_dds_message);
  __ros_msg_type_message_pkg__srv__AddThreeInts_Request * ros_message = static_cast<__ros_msg_type_message_pkg__srv__AddThreeInts_Request *>(untyped_ros_message);
  // Field name: a
  {
...
static const char *
take_message_pkg__srv__AddThreeInts_Request(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_message_pkg__srv__AddThreeInts_Request(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_message_pkg__srv__AddThreeInts_Request(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_message_pkg__srv__AddThreeInts_Request dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__srv__AddThreeInts_Request(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_message_pkg__srv__AddThreeInts_Request);
...
static const char *
deserialize_message_pkg__srv__AddThreeInts_Request(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_message_pkg__srv__AddThreeInts_Request(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t AddThreeInts_Request__callbacks = {
  "message_pkg::srv",  // message_namespace
  "AddThreeInts_Request",  // message_name
  register_type_message_pkg__srv__AddThreeInts_Request,  // register_type
  publish_message_pkg__srv__AddThreeInts_Request,  // publish
  take_message_pkg__srv__AddThreeInts_Request,  // take
  serialize_message_pkg__srv__AddThreeInts_Request,  // serialize message
  deserialize_message_pkg__srv__AddThreeInts_Request,  // deserialize message
  convert_ros_to_dds_message_pkg__srv__AddThreeInts_Request,  // convert_ros_to_dds
  convert_dds_to_ros_message_pkg__srv__AddThreeInts_Request,  // convert_dds_to_ros
};

static rosidl_message_type_support_t AddThreeInts_Request__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &AddThreeInts_Request__callbacks,  // data
...
{
  return &AddThreeInts_Request__type_support;
}
...
using __dds_msg_type_message_pkg__srv__AddThreeInts_Response = message_pkg::srv::dds_::AddThreeInts_Response_;
using __ros_msg_type_message_pkg__srv__AddThreeInts_Response = message_pkg__srv__AddThreeInts_Response;

static message_pkg::srv::dds_::AddThreeInts_Response_TypeSupport _type_support_message_pkg__srv__AddThreeInts_Response;

static const char *
register_type_message_pkg__srv__AddThreeInts_Response(void * untyped_participant, const char * type_name)
{
  if (!untyped_participant) {
    return "untyped participant handle is null";
  }
  ...
  DDS::ReturnCode_t status = _type_support_message_pkg__srv__AddThreeInts_Response.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
...
static const char *
convert_ros_to_dds_message_pkg__srv__AddThreeInts_Response(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __ros_msg_type_message_pkg__srv__AddThreeInts_Response * ros_message = static_cast<const __ros_msg_type_message_pkg__srv__AddThreeInts_Response *>(untyped_ros_message);
  __dds_msg_type_message_pkg__srv__AddThreeInts_Response * dds_message = static_cast<__dds_msg_type_message_pkg__srv__AddThreeInts_Response *>(untyped_dds_message);
  // Field name: sum
  {
...
static const char *
publish_message_pkg__srv__AddThreeInts_Response(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
    return "data writer handle is null";
  }
  ...
  __dds_msg_type_message_pkg__srv__AddThreeInts_Response dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__srv__AddThreeInts_Response(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_message_pkg__srv__AddThreeInts_Response(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_message_pkg__srv__AddThreeInts_Response * dds_message = static_cast<const __dds_msg_type_message_pkg__srv__AddThreeInts_Response *>(untyped_dds_message);
  __ros_msg_type_message_pkg__srv__AddThreeInts_Response * ros_message = static_cast<__ros_msg_type_message_pkg__srv__AddThreeInts_Response *>(untyped_ros_message);
  // Field name: sum
  {
...
static const char *
take_message_pkg__srv__AddThreeInts_Response(
  void * dds_data_reader,
  bool ignore_local_publications,
  void * untyped_ros_message,
  bool * taken,
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_message_pkg__srv__AddThreeInts_Response(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_message_pkg__srv__AddThreeInts_Response(
  const void * untyped_ros_message,
  void * untyped_serialized_data)
{
  if (!untyped_ros_message) {
  ...
  __dds_msg_type_message_pkg__srv__AddThreeInts_Response dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__srv__AddThreeInts_Response(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_message_pkg__srv__AddThreeInts_Response);
...
static const char *
deserialize_message_pkg__srv__AddThreeInts_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_message_pkg__srv__AddThreeInts_Response(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t AddThreeInts_Response__callbacks = {
  "message_pkg::srv",  // message_namespace
  "AddThreeInts_Response",  // message_name
  register_type_message_pkg__srv__AddThreeInts_Response,  // register_type
  publish_message_pkg__srv__AddThreeInts_Response,  // publish
  take_message_pkg__srv__AddThreeInts_Response,  // take
  serialize_message_pkg__srv__AddThreeInts_Response,  // serialize message
  deserialize_message_pkg__srv__AddThreeInts_Response,  // deserialize message
  convert_ros_to_dds_message_pkg__srv__AddThreeInts_Response,  // convert_ros_to_dds
  convert_dds_to_ros_message_pkg__srv__AddThreeInts_Response,  // convert_dds_to_ros
};

static rosidl_message_type_support_t AddThreeInts_Response__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &AddThreeInts_Response__callbacks,  // data
  get_message_typesupport_handle_function,
};
...
{
  return &AddThreeInts_Response__type_support;
}
...
// forward declare type support functions
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, message_pkg, srv, AddThreeInts_Request)();
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, message_pkg, srv, AddThreeInts_Response)();

const char *
register_types__message_pkg__srv__AddThreeInts(
  void * untyped_participant, const char * request_type_name, const char * response_type_name)
{
  return message_pkg::srv::typesupport_opensplice_cpp::register_types__AddThreeInts(
    untyped_participant, request_type_name, response_type_name);
}

const char *
create_requester__message_pkg__srv__AddThreeInts(
...
{
  return message_pkg::srv::typesupport_opensplice_cpp::create_requester__AddThreeInts(
...
const char *
create_responder__message_pkg__srv__AddThreeInts(
  void * untyped_participant, const char * service_name,
  ...
  void * (*allocator)(size_t))
{
  return message_pkg::srv::typesupport_opensplice_cpp::create_responder__AddThreeInts(
    untyped_participant, service_name,
...
const char *
send_request__message_pkg__srv__AddThreeInts(
...
const char *
take_request__message_pkg__srv__AddThreeInts(
...
const char *
send_response__message_pkg__srv__AddThreeInts(
...
const char *
take_response__message_pkg__srv__AddThreeInts(
...
const char *
destroy_requester__message_pkg__srv__AddThreeInts(void * untyped_requester, void (* deallocator)(void *))
{
  return message_pkg::srv::typesupport_opensplice_cpp::destroy_requester__AddThreeInts(
    untyped_requester, deallocator);
}

const char *
destroy_responder__message_pkg__srv__AddThreeInts(void * untyped_responder, void (* deallocator)(void *))
{
  return message_pkg::srv::typesupport_opensplice_cpp::destroy_responder__AddThreeInts(
    untyped_responder, deallocator);
}

const char *
server_is_available__message_pkg__srv__AddThreeInts(
  void * requester, const rmw_node_t * node, bool * is_available)
{
  return message_pkg::srv::typesupport_opensplice_cpp::server_is_available__AddThreeInts(
...
static service_type_support_callbacks_t AddThreeInts__callbacks = {
  ...
  "AddThreeInts",
  &create_requester__message_pkg__srv__AddThreeInts,
  &destroy_requester__message_pkg__srv__AddThreeInts,
  &create_responder__message_pkg__srv__AddThreeInts,
  &destroy_responder__message_pkg__srv__AddThreeInts,
  &send_request__message_pkg__srv__AddThreeInts,
  &take_request__message_pkg__srv__AddThreeInts,
  &send_response__message_pkg__srv__AddThreeInts,
  &take_response__message_pkg__srv__AddThreeInts,
...
static rosidl_service_type_support_t AddThreeInts__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &AddThreeInts__callbacks,  // data
  get_service_typesupport_handle_function,
};

const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, message_pkg, srv, AddThreeInts)() {
  return &AddThreeInts__type_support;
}
