...
#include "message_pkg/msg/encoder__rosidl_typesupport_opensplice_c.h"
...
#include "message_pkg/msg/encoder.h"
...
using __dds_msg_type_message_pkg__msg__Encoder = message_pkg::msg::dds_::Encoder_;
using __ros_msg_type_message_pkg__msg__Encoder = message_pkg__msg__Encoder;

static message_pkg::msg::dds_::Encoder_TypeSupport _type_support_message_pkg__msg__Encoder;

static const char *
register_type_message_pkg__msg__Encoder(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_message_pkg__msg__Encoder.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_message_pkg__msg__Encoder(const void * untyped_ros_message, void * untyped_dds_message)
{
...
static const char *
publish_message_pkg__msg__Encoder(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_message_pkg__msg__Encoder dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__msg__Encoder(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_message_pkg__msg__Encoder(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
...
static const char *
take_message_pkg__msg__Encoder(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_message_pkg__msg__Encoder(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_message_pkg__msg__Encoder(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_message_pkg__msg__Encoder dds_message;
  const char * err_msg = convert_ros_to_dds_message_pkg__msg__Encoder(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_message_pkg__msg__Encoder);
...
static const char *
deserialize_message_pkg__msg__Encoder(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_message_pkg__msg__Encoder(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t Encoder__callbacks = {
  "message_pkg::msg",  // message_namespace
  "Encoder",  // message_name
  register_type_message_pkg__msg__Encoder,  // register_type
  publish_message_pkg__msg__Encoder,  // publish
  take_message_pkg__msg__Encoder,  // take
  serialize_message_pkg__msg__Encoder,  // serialize message
  deserialize_message_pkg__msg__Encoder,  // deserialize message
  convert_ros_to_dds_message_pkg__msg__Encoder,  // convert_ros_to_dds
  convert_dds_to_ros_message_pkg__msg__Encoder,  // convert_dds_to_ros
};

static rosidl_message_type_support_t Encoder__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &Encoder__callbacks,  // data
