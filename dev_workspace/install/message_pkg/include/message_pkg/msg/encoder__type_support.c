...
static rosidl_typesupport_introspection_c__MessageMember Encoder__rosidl_typesupport_introspection_c__Encoder_message_member_array[1] = {
  {
    "encodervalue",  // name
    ...
    offsetof(message_pkg__msg__Encoder, encodervalue),  // bytes offset in struct
    NULL,  // default value
