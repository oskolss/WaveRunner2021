...
bool message_pkg__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "message_pkg.srv._add_three_ints.AddThreeInts_Request",
        full_classname_dest, 52) == 0);
  }
  message_pkg__srv__AddThreeInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * message_pkg__srv__add_three_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_pkg.srv._add_three_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool message_pkg__srv__add_three_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "message_pkg.srv._add_three_ints.AddThreeInts_Response",
        full_classname_dest, 53) == 0);
  }
  message_pkg__srv__AddThreeInts_Response * ros_message = _ros_message;
  {  // sum
