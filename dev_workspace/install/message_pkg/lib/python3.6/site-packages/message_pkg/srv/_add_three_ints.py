...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from message_pkg.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from message_pkg.srv._add_three_ints import AddThreeInts_Request as Request
    from message_pkg.srv._add_three_ints import AddThreeInts_Response as Response
